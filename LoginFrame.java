...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("EasyBudget.png"))); // NOI18N
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
        ...
        try {
            ...
            AddCategory.userName = uname;
            
            if(rs.next())
            {
                 usr.setUsr(jTextField_UN.getText());
		 usr.setId(getId());
                 Check_Month_Started();
    ...
    public void Check_Month_Started() {
        ...
        String query = "SELECT budget "
                        + "FROM categories JOIN users "
                        + "ON categories.user_id = users.user_id "
                        + "WHERE username = ? and MONTH(categories.date) = MONTH(CURRENT_DATE()) "
                        + "AND YEAR(categories.date) = YEAR(CURRENT_DATE())";
        try {
            ps = MyConnection.getConnection().prepareStatement(query);
    ...
    public int getId(){
        ...
        PreparedStatement ps;
        ResultSet rs;
        String usr = jTextField_UN.getText();
