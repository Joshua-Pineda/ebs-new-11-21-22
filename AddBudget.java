...
public class AddBudget extends javax.swing.JFrame {
    ...
    public ArrayList<Budget> getBudgetList()
    {
        ...
        String query = "SELECT * FROM categories WHERE user_id = ? AND MONTH(date) = MONTH(CURRENT_DATE())"
        ...
        try {
            ...
            while(rs.next()) {
                ...
                budget = new Budget(rs.getInt("categoryID"), rs.getDate("date"), rs.getString("name"), rs.getFloat("budget"), rs.getInt("user_id"));
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MANAGE SPENDING");
    ...
    private void jButton_ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ADDActionPerformed
        if(checkInputs()){
            ...
            //*******************************************************************************************************************
            /*1*/String cname =  ((String)(jComboBox_Category.getSelectedItem()));
            ...
            String query = "INSERT INTO categories(name,user_id,budget,date) values(?, ?, ?, ?)";
    ...
    private void jButton_MODIFYActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_MODIFYActionPerformed
        if(checkInputs() && !jTextField_BudgetID.getText().equals("")){
            PreparedStatement ps;
            String updateQuery = "UPDATE categories SET budget = ? WHERE categoryID = ? AND name = ?";
            try {
                ps = MyConnection.getConnection().prepareStatement(updateQuery);
               //********************************************************************************************************************************
                 ps.setFloat(1, Float.parseFloat(jTextField_Budget.getText()));
                  ps.setInt(2, Integer.parseInt(jTextField_BudgetID.getText()));
               ps.setString(3, ((String)(jComboBox_Category.getSelectedItem())));
    ...
    private void jButton_Category1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Category1ActionPerformed
        ...
        PreparedStatement ps;
        String query = "DELETE FROM names WHERE name = ? AND user_id = ?";
        
         if(selectedItem.equals("food")
             ||selectedItem.equals("clothes")||selectedItem.equals("utilities")
             ||selectedItem.equals("transportation")||selectedItem.equals("medical")
             ||selectedItem.equals("entertainment")){
             
                 JOptionPane.showMessageDialog(null, "You cannot delete that category.");
         ...
         try {
             ...
             ps.executeUpdate();
                 ...
                 jComboBox_Category.removeItem(selectedItem);
