...
public class ManageBudget extends javax.swing.JFrame {
    ...
    public ArrayList<Spending> getSpendingList()
    {
        ...
        String query = "SELECT * FROM spending WHERE user_id = ? AND MONTH(date) = MONTH(CURRENT_DATE()) ";
        Spending spending;
        try {
            ...
            while(rs.next()) {
                ...
                spending = new Spending(rs.getInt("spending_id"), 
                       rs.getDate("date"), 
                        rs.getString("category_name"), rs.getFloat("spending_amount"));
     ...
     public void Show_Spending_In__JTable()
    {
        ...
        for(int i = 0; i < list.size(); i++)
        {
            ...
            row[2] = list.get(i).getSpendingAmount();
            row[3] = list.get(i).getMonthYear();
            model.addRow(row);
        }
      ...
      public void ShowItem(int index)
    {
            ...
            if (getSpendingList().get(index).getMonthYear() != null)
                jDateChooser_Date.setDate(getSpendingList().get(index).getMonthYear());
    ...
    public void Show_Categories_In_ComboBox() {
        PreparedStatement ps;
        String query = "SELECT name FROM names WHERE user_id =?";
        ResultSet rs;
        
        jComboBox_Category.addItem("food");
        jComboBox_Category.addItem("clothes");
        jComboBox_Category.addItem("utilities");
        jComboBox_Category.addItem("transportation");
        jComboBox_Category.addItem("medical");
        jComboBox_Category.addItem("entertainment");
         try {
             ps = MyConnection.getConnection().prepareStatement(query);
              ps.setInt(1, getUserId(userName));
             rs = ps.executeQuery();
             ...
             while(rs.next()) {
                 jComboBox_Category.addItem(rs.getString("name"));
             }
    ...
    private void initComponents() {
        ...
        jTable_Spending.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SpendingID", "Category", "Amount", "Date"
            }
        ));
    ...
    private void jButton_ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ADDActionPerformed
        if(checkInputs()){
            ...
            if (checkCatgeoryForBudget()) {
                ...
                String updateQuery = "INSERT INTO spending(user_id, date, spending_amount, category_name, category_id) values(?, ?, ?, ?, ?)";
                ...
                try {
                    ...
                    ps.setInt(1, getUserId(userName));
                    ps.setString(2, date);
                    ps.setFloat(3, (Float.parseFloat(jTextField_Spending.getText())));
                    ps.setString(4, ((String)(jComboBox_Category.getSelectedItem())));
                    ps.setInt(5,getBudgetID());
    ...
    private void jButton_DELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DELETEActionPerformed
        if(!jTextField_SpendingID.getText().equals("")) {
            ...
            try {
                PreparedStatement ps;
                String deleteQuery = "DELETE FROM spending WHERE spending_id = ?";
    ...
    private void jButton_MODIFYActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_MODIFYActionPerformed
       if(checkInputs() && !jTextField_SpendingID.getText().equals("")){
            ...
            String updateQuery = "UPDATE spending SET spending_amount = ? WHERE spending_id = ?";
            ...
            try {
                ...
                ps.setInt(2, Integer.parseInt(jTextField_SpendingID.getText()));
    ...
    public void Spending_Over_80() {
        ...
        String query1 = "SELECT budget "
                        + "FROM categories " 
                        + "WHERE categoryID = ?";
        String query2 = "SELECT SUM(spending_amount) "
                        + "FROM spending "
                        + "WHERE category_id = ? "
        ...
        try {
            ...
            if(rs2.next()) {
                spendingAmount = rs2.getFloat("SUM(spending_amount)");
    ...
    public float getLastSpending(){
        String query = "SELECT spending_amount "
                + " FROM spending "
                + " WHERE categoryID = ? " 
        ...
        try {
            ...
            rs = ps.executeQuery();
            if (rs.next()) {
                lastSpending = rs.getFloat("spending_amount");
            }
        } catch (SQLException ex) {
            Logger.getLogger(ManageBudget.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public boolean checkCatgeoryForBudget() {
        PreparedStatement ps;
        String query = "SELECT categoryID FROM categories WHERE name = ? and MONTH(date) = MONTH(CURRENT_DATE()) "
    ...
    public int getBudgetID() {
        ...
        try {
            ps = MyConnection.getConnection().prepareStatement(query);
            ps.setString(1, ((String)(jComboBox_Category.getSelectedItem())));
            ps.setInt(2, getUserId(userName));
            rs = ps.executeQuery();
            
            if (rs.next()) {
                budgetID = rs.getInt("categoryID");
